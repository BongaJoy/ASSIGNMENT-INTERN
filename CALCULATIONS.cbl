      ...
      ******************************************************************
       ...
       01 WS-OK                        PIC X.
       01 WS-ID-EXIST                  PIC X.
       01 WS-OPTION-RESPOND            PIC 9.
       01 PIZZA-COUNT                  PIC 9.
       01 PASTA-COUNT                  PIC 9.
       01 PAP-N-WORS-COUNT             PIC 9.
       01 WS-EOF                       PIC XX.
       01 ERR-MESSAGE                  PIC X(100).
       01 WS-TOTAL-AGE                 PIC 9999.
       ...
       01 WS-PERC-PIZZA                PIC 999.
       01 WS-PERC-PASTA                PIC 999.
       01 WS-PERC-PAP                  PIC 999.

       01 WS-OUT-AVAG                  PIC 999.
       01 WS-MOVIE-AVAG                PIC 999.
       01 WS-TV-AVAG                   PIC 999.
       01 WS-RADIO-AVAG                PIC 999.
     ...
     -                                                   LINE 2 COL 2.
       ...
       01 RESULTS-SCREEN.
           ...
           05  VALUE "Total number of survey:"            LINE 4 COL 10.
